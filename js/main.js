const app = new Vue({
  ...
  data: {
    ...
    isMenuOpen: false,
    products: [
                { id: 1, title: 'Beet Hybrid B1', short_text: 'Высокая устойчивость и отличный вкус', image: 'img/b1.png' },
                { id: 2, title: 'Beet Hybrid B2', short_text: 'Раннеспелый гибрид для открытого грунта', image: 'img/b2.png' },
                { id: 3, title: 'Beet Hybrid B3', short_text: 'Идеально подходит для тепличных условий', image: 'img/b3.png' },
                { id: 4, title: 'Beet Hybrid B4', short_text: 'Устойчив к вирусу BYLCV', image: 'img/b4.png' },
                { id: 5, title: 'Beet Hybrid B5', short_text: 'Длительный срок хранения и ярко-красный цвет', image: 'img/b5.png' }
            ],
    product: {},
    btnVisible: 0,
